...
class TestCommandDownload:
    ...
    def test_library_checker(self, config_dir: ConfigDirFunc):
    ...
    def test_yukicoder(self, config_dir: ConfigDirFunc):
    ...
    @pytest.mark.integration
    def test_aizu_onlinejudge(self, config_dir: ConfigDirFunc):
